 ...
 */
final class Version20200608224452 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE professeur (id INT AUTO_INCREMENT NOT NULL, departement_id INT NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, cin VARCHAR(10) NOT NULL, adresse VARCHAR(40) NOT NULL, telephone VARCHAR(30) NOT NULL, email VARCHAR(30) NOT NULL, date_recrutement DATETIME NOT NULL, INDEX IDX_17A55299CCF9E01E (departement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
